...
export class FilmService {
	...
	private films: Array<Film> = [
		...
		{ id: 13, name: "Чуваши", year: "2014", imgUrl: "https://image.tmdb.org/t/p/w300_and_h450_bestv2/5IGqQ86P8dfpNShocqz8rx38mv0.jpg", description: "ррррррррррррррр рррррррр рррррррррррр рррррррр ррррррррр ррррррррррр рррррррррррр рррррррррр рррррррррррррррр рррррррррррррррррр ррррррррррр  ррррр            рррр" },
	];

	getData() {
		const portion = 3;
		return {
			data: this.filmsCopy.splice(0, portion),
			count: this.films.length / portion
		}
	}
...
// американский пилот и рассказывает о серьезном конфликте, бушующем во внешнем мире, Диана покидает свой дом, чтобы справиться с этой угрозой